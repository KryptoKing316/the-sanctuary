      ...
      <div className="flex-1 overflow-y-auto pb-[80px]">
        ...
        <div className="relative w-full overflow-hidden" style={{ height: '360px' }}>
          ...
          <div className="absolute bottom-7 left-0 right-0 text-center z-10 px-5">
            ...
            <h1 className="font-display text-ivory" style={{ fontSize: '28px', fontWeight: 900, letterSpacing: '0.05em', textShadow: '0 0 20px rgba(201,168,76,1),0 0 40px rgba(201,168,76,0.6),0 2px 6px rgba(0,0,0,1)' }}>The Sanctuary</h1>
